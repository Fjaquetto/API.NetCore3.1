using APIEstudoAngular.API.DTOs.AuthDTO;
...
namespace APIEstudoAngular.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            if (!ModelState.IsValid) return BadRequest("Modelo de entrada inválido.");
        ...
        public async Task<ActionResult> Login(LoginUserDTO loginUser)
        {
            ...
            if (result.Succeeded)
            {
                return Ok(await this.GerarJwt(loginUser.Email));
            }
